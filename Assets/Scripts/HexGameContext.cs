...
{
    [Header("Core")]
    [SerializeField] private HexConfig config;
    [SerializeField] private HexPoolService poolService;

    [Header("Links")]
    [SerializeField] private HexManager manager;
    [SerializeField] private HexStacksCreator stacksCreator;
    [SerializeField] private HexFloorCreator floorCreator;
