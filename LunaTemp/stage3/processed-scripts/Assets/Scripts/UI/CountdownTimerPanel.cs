...
public class CountdownTimerPanel : MonoBehaviour
{
    ...
    [Header("Colors")]
    [SerializeField] private Color barFrameNormalColor = new UnityEngine.Color(0.11f, 0.38f, 0.86f, 1f);
    [SerializeField] private Color barBackNormalColor = new UnityEngine.Color(0.06f, 0.22f, 0.58f, 1f);
    [SerializeField] private Color barFillNormalColor = new UnityEngine.Color(0.35f, 0.95f, 0.18f, 1f);
    [SerializeField] private Color iconFrameNormalColor = new UnityEngine.Color(0.1f, 0.37f, 0.86f, 1f);
    [SerializeField] private Color iconBackNormalColor = new UnityEngine.Color(0.98f, 0.99f, 1f, 1f);

    [SerializeField] private Color barFrameLowColor = new UnityEngine.Color(0.93f, 0.12f, 0.12f, 1f);
    [SerializeField] private Color barBackLowColor = new UnityEngine.Color(0.55f, 0.02f, 0.02f, 1f);
    [SerializeField] private Color barFillLowColor = new UnityEngine.Color(0.95f, 0.17f, 0.17f, 1f);
    [SerializeField] private Color iconFrameLowColor = new UnityEngine.Color(0.93f, 0.12f, 0.12f, 1f);
    [SerializeField] private Color iconBackLowColor = new UnityEngine.Color(1f, 0.92f, 0.92f, 1f);

    [Header("Arrow")]
    [SerializeField] private float arrowStartAngle = 45f;
    [SerializeField] private float arrowEndAngle = -235f;
    [SerializeField] private Color arrowNormalColor = new UnityEngine.Color(0.9f, 0.2f, 0.2f, 1f);
