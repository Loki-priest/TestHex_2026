...
[Bridge.Ref]         Color tintColor
    ...
    private ParticleSystem RentClearTilesFx(HexPoolService poolService, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation)
    {
    ...
    private static void TintParticleSystems(ParticleSystem rootFx, [Bridge.Ref] Color tintColor)
    {
        if (rootFx == null)
        {
            return;
