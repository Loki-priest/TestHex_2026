...
public class HexStacksCreator : MonoBehaviour
{
    ...
    private readonly HashSet<HexStack> pendingPlacementStacks = new System.Collections.Generic.HashSet<HexStack>();
    private readonly HashSet<HexStack> runtimePooledStacks = new System.Collections.Generic.HashSet<HexStack>();
    ...
    private HexStack RentStack(HexStack prefab, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation, Transform parent)
    {
        HexPoolService poolService = PoolService;
        if (poolService != null)
        {
