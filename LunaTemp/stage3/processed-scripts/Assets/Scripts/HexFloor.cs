...
public class HexFloor : MonoBehaviour
{
    ...
    private List<HexFloor> nearFloors = new System.Collections.Generic.List<HexFloor>();
    ...
    [SerializeField] private Color dropHighlightColor = new UnityEngine.Color(0.35f, 1f, 0.45f, 1f);
    [SerializeField, Range(0f, 1f)] private float dropHighlightBlend = 0.55f;
    [SerializeField] private bool useEmissionHighlight = true;
    [SerializeField] private Color dropHighlightEmissionColor = new UnityEngine.Color(0.08f, 0.38f, 0.08f, 1f);
    ...
    [SerializeField] private Color gizmoNoNeighborColor = new UnityEngine.Color(1f, 0.65f, 0f, 0.9f);
    [SerializeField] private Color gizmoNeighborColor = new UnityEngine.Color(0.2f, 1f, 0.3f, 0.9f);
    ...
    private readonly List<RendererHighlightState> highlightStates = new System.Collections.Generic.List<HexFloor.RendererHighlightState>();
    ...
    private void CacheHighlightRenderers()
    {
        ...
        HashSet<Renderer> uniqueRenderers = new System.Collections.Generic.HashSet<UnityEngine.Renderer>();
        for (int i = 0; i < renderers.Length; i++)
        {
            ...
            RendererHighlightState state = new HexFloor.RendererHighlightState()
            {
                Renderer = renderer,
