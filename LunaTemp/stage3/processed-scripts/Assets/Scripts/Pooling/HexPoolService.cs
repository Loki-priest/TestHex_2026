...
public class HexPoolService : MonoBehaviour
{
    ...
    public HexStack RentStack(HexStack prefab, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation, Transform parent = null)
    {
        EnsurePoolsInitialized();
    ...
    public HexTile RentTile(HexTile prefab, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation, Transform parent = null)
    {
        EnsurePoolsInitialized();
    ...
    public ParticleSystem RentFx(ParticleSystem prefab, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation, Transform parent = null)
    {
        EnsurePoolsInitialized();
    ...
    private sealed class ComponentPool<T> where T : Component
    {
        ...
        private readonly Dictionary<int, Queue<T>> bucketsByPrefab = new System.Collections.Generic.Dictionary<int, System.Collections.Generic.Queue<T>>();
        private readonly Dictionary<T, int> prefabIdByInstance = new System.Collections.Generic.Dictionary<T, int>();
        private readonly HashSet<T> inactiveInPool = new System.Collections.Generic.HashSet<T>();
        ...
        public T Rent(T prefab, [Bridge.Ref] Vector3 position, [Bridge.Ref] Quaternion rotation, Transform parent)
        {
            if (prefab == null)
            {
                return null;
