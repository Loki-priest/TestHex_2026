...
public class HexManager : MonoBehaviour
{
    ...
    private IEnumerator ResolveTopColorTransferRoutine(HexStack sourceStack, HexFloor sourceFloor, Action onComplete)
    {
        ...
        try
        {
            ...
            Queue<HexStack> pendingStacks = new System.Collections.Generic.Queue<HexStack>();
            HashSet<HexStack> queuedStacks = new System.Collections.Generic.HashSet<HexStack>();
    ...
    private IEnumerator ClearBatchesParallelRoutine(List<StackClearBatch> clearBatches, float speedMultiplier)
    {
        ...
        List<Tween> clearTweens = new System.Collections.Generic.List<DG.Tweening.Tween>();
